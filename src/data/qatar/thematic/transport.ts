...
Karwa, operated by Mowasalat, is Qatar's official bus and taxi service. The bus network covers most of greater Doha with over 80 routes, and fares start at QAR 3 (~€0.75) per ride. Karwa taxis are recognisable by their turquoise colour and charge a starting fare of QAR 10 (~€2.50) plus QAR 1.60 (~€0.40) per kilometre. All taxis are metered. For ride-hailing, Uber and Careem both operate in Doha, and Karwa also has its own app for booking taxis. Ride-hailing tends to be slightly more expensive than street hailing but offers cashless payment and trip tracking.

Parking in Doha can be challenging, particularly in West Bay and the Souq Waqif area. Street parking is metered in many central locations (QAR 2-3 / ~€0.50-0.75 per hour), and parking violations are actively enforced. Most shopping malls and residential buildings provide free or subsidised parking. The Ministry of Interior has implemented a traffic points system; accumulating 14 points within a year results in licence suspension.

Car ownership is straightforward in Qatar. New and used vehicles are available from dealerships across the city. Popular choices among expats include Toyota Land Cruiser, Nissan Patrol, and various Japanese and Korean sedans. Annual registration renewal costs around QAR 100-300 (~€25-75) depending on the vehicle type, and comprehensive insurance typically costs QAR 1,500-4,000 (~€375-1,000) per year. Petrol prices remain among the lowest in the world, with a full tank costing around QAR 80-150 (~€20-38) for a standard sedan.
  ...
  faqs: [
    {
      ...
      answer:
        "The Doha Metro is very affordable. A standard single journey costs QAR 2 (~€0.50), a day pass costs QAR 10 (~€2.50), and a rechargeable travel card can be loaded with credit for regular use. Gold Class carriages (first class, with quieter and more spacious seating) are available for QAR 10 (~€2.50) per journey. Monthly passes are also available. Children under 6 ride free, and people of determination travel at no charge.",
    },
    {
