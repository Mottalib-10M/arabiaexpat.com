  ...
  types: [
    {
      ...
      cost: "QAR 1,000-3,000 (~€250-750) (covered by employer per law)",
    },
    {
      ...
      cost: "QAR 1,000-2,000 (~€250-500)",
    },
    {
      name: "Family Visit Visa",
      duration: "1-3 months",
      requirements: ["Sponsor with minimum salary QAR 10,000 (~€2,500)", "Family relationship proof", "Accommodation proof"],
      process: "Sponsor applies through Metrash2 app or MOI website. Processing: 3-7 business days.",
      cost: "QAR 200-500 (~€50-125)",
    },
  ],
  generalNotes: [
    "The kafala (sponsorship) system has been reformed allowing job mobility.",
    "Minimum wage of QAR 1,000/month (~€250/month) applies to all workers.",
