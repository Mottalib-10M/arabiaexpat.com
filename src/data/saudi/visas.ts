  ...
  types: [
    {
      ...
      cost: "SAR 2,000-6,000 (~€480-1,440) (employer bears cost per law)",
    },
    {
      name: "Premium Residency",
      duration: "Permanent or 1-year renewable",
      requirements: ["Permanent: SAR 800,000 (~€192,000) one-time fee", "Renewable (1-year): SAR 100,000 (~€24,000) annual fee", "Clean criminal record", "Valid passport", "Medical fitness", "Financial solvency proof"],
      ...
      cost: "SAR 100,000 (~€24,000) (annual) or SAR 800,000 (~€192,000) (permanent)",
    },
    {
      name: "Visit Visa",
      ...
      cost: "SAR 300-535 (~€72-128)",
    },
  ],
  generalNotes: [
    "The Iqama (residence permit) must be renewed before expiry.",
    "Dependent visa requires minimum salary of SAR 4,000/month (~€960/month).",
