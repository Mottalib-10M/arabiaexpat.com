...
SEC has deployed smart meters in many parts of Jeddah, and the ALKAHRABA app provides consumption tracking and digital bill payment. The city also benefits from a growing solar energy sector, with some newer residential developments incorporating rooftop solar panels that can reduce electricity costs. NWC's customer service in Jeddah has improved with the introduction of online reporting for leaks, billing disputes, and service requests through their Moya app.`,
    },
    {
      city: "Dammam",
      slug: "dammam",
      content: `The Eastern Province's utility infrastructure benefits from proximity to Saudi Arabia's energy production centres. Electricity supply in Dammam, Al Khobar, and Dhahran is generally reliable, with SEC managing the grid for the region. Summer temperatures in the Eastern Province are comparable to Riyadh (often exceeding 45C) with added coastal humidity in Dammam and Al Khobar, making air conditioning costs significant. Monthly electricity bills for a three-bedroom unit typically range from SAR 250 to SAR 500 (~€60-120) in winter and SAR 700 to SAR 1,500 (~€168-360) in summer.

Within Saudi Aramco residential compounds in Dhahran, utilities are typically included in the housing package provided to employees. Aramco manages its own power and water infrastructure within the compound, and residents do not receive individual utility bills. This is a significant financial benefit that can save Aramco employees SAR 1,000 to SAR 3,000 (~€240-720) or more per month compared to non-compound living.

For non-Aramco expats in the metropolitan area, utility services follow the standard SEC and NWC arrangements. Water in the Eastern Province is sourced from a combination of desalination, groundwater, and treated wastewater (for non-potable uses). Monthly water bills for apartments are typically SAR 40 to SAR 180 (~€10-43), slightly lower than Jeddah due to the availability of local groundwater sources that supplement desalinated supply.
  ...
  faqs: [
    {
      ...
      answer:
        "Total monthly utility costs for a typical three-bedroom apartment range from SAR 400 to SAR 800 (~€96-192) in cooler months and SAR 1,000 to SAR 2,500 (~€240-600) during summer, with electricity being the largest component due to air conditioning. This includes electricity (SAR 250-2,000 / ~€60-480), water (SAR 40-250 / ~€10-60), cooking gas (SAR 18 (~€4) per cylinder, lasting 4-6 weeks), and does not include internet (covered separately). Actual costs depend heavily on property size, insulation quality, and AC usage habits.",
    },
    {
