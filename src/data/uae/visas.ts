  ...
  types: [
    {
      ...
      cost: "AED 3,000-5,000 (typically covered by employer)",
    },
    {
      name: "Golden Visa",
      duration: "10 years (renewable)",
      requirements: ["Investors with AED 2M+ property or business investment", "Specialized talent (scientists, doctors, engineers)", "Outstanding students with GPA 3.8+", "Entrepreneurs with approved projects"],
    ...
    },
    {
      ...
      requirements: ["Skilled workers earning AED 15,000+ monthly", "Freelancers with valid permit", "Investors in commercial enterprises"],
      process: "Self-sponsored residence. Apply through ICA portal. No employer sponsor required.",
      cost: "AED 2,200-3,500",
    },
    {
      ...
      cost: "AED 7,500-15,000 annually (including free zone license)",
    },
  ],
  generalNotes: [
