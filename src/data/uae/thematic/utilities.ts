...
Electricity in the UAE is predominantly generated from natural gas, with an increasing share coming from solar (Mohammed bin Rashid Al Maktoum Solar Park, the world's largest single-site solar park, in Dubai) and nuclear energy (Barakah Nuclear Power Plant in Abu Dhabi). Tariffs for expats are significantly higher than for UAE nationals — in Dubai, expats pay AED 0.38 per kilowatt-hour (kWh) for usage up to 2,000 kWh and AED 0.44 for usage above that, compared to AED 0.23 for citizens in the lowest tier. Water tariffs follow a similar pattern, with expats paying AED 10.65 per 1,000 imperial gallons (up to 6,000 gallons) and higher rates for excess usage. The average monthly utility bill for an expat household in a two-bedroom apartment ranges from AED 500 to AED 1,200, depending on usage and season — bills spike dramatically during summer (June–September) when air conditioning runs continuously.

District cooling is an important cost consideration in many newer Dubai developments. Unlike buildings with individual AC units charged through DEWA, district-cooling buildings receive chilled water from a central plant, and the cost appears as a separate charge on top of the DEWA bill. District-cooling providers include Empower and Emicool in Dubai, and Tabreed in Abu Dhabi. Charges are based on consumption (measured in ton-hours) with a minimum monthly fee, and can range from AED 200/month in winter to AED 1,000+/month in summer for a two-bedroom apartment. Tenants should always check whether a property is on district cooling before signing a lease, as this cost is not always included in DEWA bills.`,
  citySections: [
    {
      city: "Dubai",
      slug: "dubai",
      content: `In Dubai, all electricity and water services are provided by DEWA (Dubai Electricity and Water Authority). To set up a new DEWA account, you need your Ejari (registered tenancy contract), passport with visa, and Emirates ID. Registration can be done online through the DEWA app or website, or at a DEWA customer service centre. A refundable security deposit is required: AED 2,000 for apartments and AED 4,000 for villas. The activation fee is AED 100 (for existing connections) or AED 300 (for new connections), and processing typically takes 1–2 working days. DEWA's smart meters enable real-time usage tracking through the DEWA app, allowing residents to monitor consumption and manage costs proactively.

DEWA's tariff structure for expat residents (non-nationals) is as follows. Electricity: AED 0.23/kWh for the first 2,000 kWh, AED 0.28/kWh for 2,001–4,000 kWh, AED 0.32/kWh for 4,001–6,000 kWh, and AED 0.38/kWh above 6,000 kWh. A fuel surcharge of AED 0.065/kWh applies to all consumption. Water: AED 4.49 per 1,000 imperial gallons for the first 6,000 gallons, AED 5.48 for 6,001–12,000 gallons, AED 6.02 for 12,001–20,000 gallons, and AED 10.65 above 20,000 gallons. A sewerage charge of 5% of the total DEWA bill is also applied. Additionally, all tenants in Dubai pay a housing fee of 5% of the annual rent, split into 12 monthly instalments added to the DEWA bill. For a typical two-bedroom apartment, expect monthly DEWA bills of AED 500–800 in winter and AED 800–1,500 in summer.

For properties on district cooling, the separate chiller charges can be substantial. Empower, Dubai's largest district-cooling provider, uses a tariff of approximately AED 0.169 per ton-hour of cooling consumed, plus a demand charge based on the connected capacity. Monthly charges for a two-bedroom apartment on district cooling typically range from AED 200–400 in cooler months to AED 800–1,200 in peak summer. Some newer developments include a fixed chiller allowance in the service charge, which simplifies budgeting. Gas supply for cooking is provided via piped natural gas in most modern buildings (charged by DEWA at AED 3.50 per therm) or bottled gas cylinders (AED 30 per 25-kg cylinder) in older or villa properties. DEWA bills can be paid online, through the app, at payment kiosks, or via auto-debit from your bank account.`,
    },
    {
      city: "Abu Dhabi",
      slug: "abu-dhabi",
      content: `In Abu Dhabi, electricity and water are distributed by the Abu Dhabi Distribution Company (ADDC) for the city of Abu Dhabi and the Western Region, and by Al Ain Distribution Company (AADC) for the Al Ain area. To set up an ADDC account, you need a Tawtheeq tenancy contract, passport, Emirates ID, and a security deposit of AED 2,000 for apartments or AED 4,000 for villas (refundable upon final disconnection). Registration can be completed through the ADDC website, mobile app, or at a customer service centre. Activation usually takes 1–3 working days.

ADDC's tariff structure differs from DEWA's and is generally slightly lower. For expat residents, electricity is charged at a flat rate of approximately AED 0.30/kWh, with an additional fuel surcharge. Water is charged at approximately AED 10.40 per 1,000 imperial gallons. A sewerage fee of AED 0.05/imperial gallon also applies. Unlike Dubai, Abu Dhabi does not levy a municipal housing fee through the utility bill — instead, the municipality fee is incorporated into the Tawtheeq registration or applied differently. The average monthly ADDC bill for a two-bedroom apartment in Abu Dhabi ranges from AED 400–700 in winter to AED 700–1,300 in summer. Villas tend to be more expensive, with bills of AED 1,000–2,500/month in summer due to larger areas requiring cooling.
  ...
  faqs: [
    {
      ...
      answer:
        "For a two-bedroom apartment, expect AED 500–800/month in winter and AED 800–1,500/month in summer from DEWA (Dubai) or ADDC (Abu Dhabi). Villas cost significantly more: AED 1,000–3,000/month. These figures cover electricity, water, and sewerage but exclude district cooling (add AED 200–1,200/month) and the 5% Dubai housing fee.",
    },
    {
      question: "What is the DEWA security deposit and is it refundable?",
      answer:
        "DEWA requires a refundable security deposit of AED 2,000 for apartments and AED 4,000 for villas. The deposit is returned upon final account disconnection, minus any outstanding charges. A similar deposit is required by ADDC in Abu Dhabi. Some landlords include the deposit in the tenancy agreement and handle it on behalf of the tenant.",
    },
    {
