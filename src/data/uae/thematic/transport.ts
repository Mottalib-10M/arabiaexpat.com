...
For inter-city travel, the Abu Dhabi–Dubai bus (E100/E101) departs every 15–30 minutes from Al Ghubaiba or Ibn Battuta stations, costs AED 25 (~€6.25), and takes approximately 90 minutes. The Sharjah–Dubai bus routes are equally frequent. Long-term, the Etihad Rail network will connect Abu Dhabi, Dubai, and other emirates by rail, with passenger services expected in the coming years.`,
    },
    {
      city: "Abu Dhabi",
      slug: "abu-dhabi",
      content: `Abu Dhabi's public transport network is less extensive than Dubai's and centred primarily around buses. The Department of Municipalities and Transport (DMT) operates a network of local and intercity bus routes, with main hubs at Abu Dhabi Central Bus Station (on Hazza Bin Zayed Street) and Al Wahda Mall. Bus fares are AED 2 (~€0.50) per journey using a Hafilat card (Abu Dhabi's equivalent of the nol card). While the bus network covers most major areas including Yas Island, Saadiyat Island, and Khalifa City, frequencies can be low (every 20–60 minutes on some routes), making it impractical as a primary mode of transport for many expats.
  ...
  faqs: [
    {
      ...
      answer:
        "Fares depend on the number of zones crossed. With a Silver nol card: AED 3 (~€0.75) within one zone, AED 5 (~€1.25) for two zones, and AED 7.50 (~€1.88) for a full journey across all zones. Gold Class is roughly double. A monthly unlimited pass costs AED 350 (~€88) for all zones. The Metro operates from 5:00 AM to midnight (Saturday–Wednesday), extending to 1:00 AM on Thursday and Friday.",
    },
    {
      question: "What is Salik and how much does it cost?",
      answer:
        "Salik is Dubai's electronic road-toll system. Each gate crossing costs AED 4 (~€1), with a daily maximum of AED 24 (~€6) (6 charges). A Salik tag costs AED 50 (~€12.50) and can be purchased online or at petrol stations. The tag is linked to a prepaid account that must maintain a minimum AED 100 (~€25) balance. Most regular commuters spend AED 400–800/month (~€100–200/month) on Salik.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "It depends on your location and lifestyle. In Dubai, if you live near a Metro station and work in DIFC/Downtown/Media City, public transport can be sufficient. In Abu Dhabi, a car is almost essential due to limited public transport. Car ownership costs roughly AED 2,000–4,000/month (~€500–1,000/month) (loan, insurance, fuel, tolls, parking) versus AED 1,500–3,000/month (~€375–750/month) for regular taxi/ride-hailing use.",
    },
    {
      question: "How much does car insurance cost in the UAE?",
      answer:
        "Third-party insurance (the legal minimum) costs AED 700–1,200 (~€175–300) per year. Comprehensive insurance ranges from AED 1,500 (~€375) to AED 4,000+ (~€1,000+), depending on the vehicle's value, your age, and driving history. Premiums are lower for drivers over 25 with a clean record. Insurance can be purchased online through aggregators like Yallacompare or directly from insurers such as AXA, RSA, and Oman Insurance.",
    },
  ],
  sources: [
    {
