...
export const mainNav: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "Visa Guide", href: "/uae/visa/" },
      { label: "Cost of Living", href: "/uae/cost-of-living/" },
      { label: "Education", href: "/uae/education/" },
      { label: "Healthcare", href: "/uae/healthcare/" },
      { label: "Housing", href: "/uae/housing/" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Visa Guide", href: "/qatar/visa/" },
      { label: "Cost of Living", href: "/qatar/cost-of-living/" },
      { label: "Education", href: "/qatar/education/" },
      { label: "Healthcare", href: "/qatar/healthcare/" },
      { label: "Housing", href: "/qatar/housing/" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Visa Guide", href: "/saudi-arabia/visa/" },
      { label: "Cost of Living", href: "/saudi-arabia/cost-of-living/" },
      { label: "Education", href: "/saudi-arabia/education/" },
      { label: "Healthcare", href: "/saudi-arabia/healthcare/" },
      { label: "Housing", href: "/saudi-arabia/housing/" },
...
export const footerNav = {
  ...
  countryTopics: [
    { label: "UAE Education", href: "/uae/education/" },
    { label: "UAE Housing", href: "/uae/housing/" },
    { label: "Qatar Education", href: "/qatar/education/" },
    { label: "Qatar Housing", href: "/qatar/housing/" },
    { label: "Saudi Education", href: "/saudi-arabia/education/" },
    { label: "Saudi Housing", href: "/saudi-arabia/housing/" },
  ],
  resources: [
    { label: "UAE Visa Guide", href: "/uae/visa/" },
    { label: "Qatar Visa Guide", href: "/qatar/visa/" },
    { label: "Saudi Visa Guide", href: "/saudi-arabia/visa/" },
