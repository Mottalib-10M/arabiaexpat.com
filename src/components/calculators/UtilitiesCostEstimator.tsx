    ...
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
      ...
      <div className="space-y-2 mb-3">
        <div className="flex justify-between text-sm">
          ...
          <span className="text-right shrink-0 ml-2">
            ...
            <span className="block text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(breakdown.elecWater, currency)}</span>
          </span>
        </div>
        <div className="flex justify-between text-sm">
          ...
          <span className="text-right shrink-0 ml-2">
            ...
            <span className="block text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(breakdown.internet, currency)}</span>
          </span>
        </div>
        <div className="flex justify-between text-sm">
          ...
          <span className="text-right shrink-0 ml-2">
            ...
            <span className="block text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(breakdown.mobile, currency)}</span>
          </span>
        </div>
      </div>
      <div className="flex items-start justify-between p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(breakdown.total, currency)}</p>
        </div>
