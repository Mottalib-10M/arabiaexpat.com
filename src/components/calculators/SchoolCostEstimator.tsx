    ...
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
      ...
      <div className="flex items-start justify-between p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(annualPerChild, currency)}</p>
        </div>
        {numChildren > 1 && (
          <div className="text-right shrink-0">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(totalAnnual, currency)}</p>
          </div>
        )}
        {numChildren === 1 && (
          <div className="text-right shrink-0">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 tabular-nums">{formatEURPart(Math.round(totalAnnual / 12), currency)}</p>
          </div>
        )}
      </div>
